...
void function InitAdvancedHudMenu()
{
	...
	SetupButton( Hud_GetChild( menu, "SwitchBloomEnable" ), "Show Bloom", "Toggles the bloom to reduce brightness and glare" )
...
void function ResetSettingsToDefaults()
{
	...
	SetConVarToDefault( "mat_disable_bloom" )
	SetConVarToDefault( "cl_showfps" )
	SetConVarToDefault( "showfps_enabled" )
	SetConVarToDefault( "cl_showpos" )
